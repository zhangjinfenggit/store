...
public class EmpAlterDialog extends JDialog {
	...
	public EmpAlterDialog(JFrame frame, final JTable table, final String id) {
		...
		textField_5.setText(Emp.getAge() + "");
		textField_5.setBounds(335, 71, 131, 21);
		getContentPane().add(textField_5);

		JLabel label_10 = new JLabel("修改员工信息");
		...
		textField_1.setText(Emp.getPhone());
		textField_1.setBounds(335, 137, 131, 21);
		getContentPane().add(textField_1);

		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setText(Emp.getTel());
		...
		textField_3.setText(Emp.getFax());
		...
		textField_6.setText(Emp.getAddress());
