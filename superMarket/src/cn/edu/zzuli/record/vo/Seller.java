...
public class Seller {
	...
	public String toString() {
		return "Seller [sid=" + sid + ", name=" + name + ", address=" + address + " contel=" + contel + ", fax=" + fax
				+ ", email=" + email + ", account=" + account + ", wsite=" + wsite + ", description=" + description
				+ "]";
	}
