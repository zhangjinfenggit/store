...
public class SellerAlterDialog extends JDialog {
	...
	public SellerService service = null;

	public JDialog getJDialog() {
		return this;
	}

	public SellerAlterDialog(JFrame frame, final JTable table, final String id) {
		...
		// this.setBounds(width, height, 600, 400);
		...
		textField.setText(seller.getName());
		textField.setBounds(95, 50, 131, 21);
		getContentPane().add(textField);
		textField.setColumns(10);

		textField_1 = new JTextField();
		textField_1.setText(seller.getFax());
		...
		textField_2.setText(seller.getConnecter());
		textField_2.setBounds(95, 113, 131, 21);
		getContentPane().add(textField_2);

		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setText(seller.getEmail());
		textField_3.setBounds(95, 144, 131, 21);
		getContentPane().add(textField_3);

		textField_4 = new JTextField();
		textField_4.setColumns(10);
		textField_4.setText(seller.getAccount());
		...
		textField_5.setText(seller.getAddress());
		...
		textField_6.setText(seller.getContel());
		textField_6.setBounds(345, 145, 131, 21);
		getContentPane().add(textField_6);

		textField_7 = new JTextField();
		textField_7.setColumns(10);
		textField_7.setText(seller.getPostCode());
		textField_7.setBounds(345, 82, 131, 21);
		getContentPane().add(textField_7);

		textField_8 = new JTextField();
		textField_8.setColumns(10);
		textField_8.setText(seller.getWsite());
		...
		textArea.setText(seller.getDescription());
