...
public class DeptAlterDialog extends JDialog {
	...
	public DeptAlterDialog(JFrame frame, final JTable table, String id) {

		super(frame, false);
		service = new DeptService();
		Dept = service.getDeptById(id);
		...
		textField_5.setText(Dept.getPrincipal());
		...
		textArea.setText(Dept.getDescription());
