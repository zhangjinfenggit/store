 ...
 * 
 * @author zhangjinfeng
 * @date 2017年6月1日下午3:04:39 TODO
 */
public class InStoreAlterDialog extends JDialog {
	...
	private InStoreService service = null;
	private InStore InStore = null;
	...
	public InStoreAlterDialog(JFrame frame, final JTable table, final String id) {

		super(frame, false);
		service = new InStoreService();
		InStore = service.getInStoreById(id);
		...
		textField_1.setText(InStore.getWeight() + "");
		...
		textField_5.setText(InStore.getWareName());
		...
		textArea.setText(InStore.getRemark());
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				InStore.setId(Integer.parseInt(id));
				InStoreService service = new InStoreService();
				service.updateInStore(InStore);
