...
public class StoreAlterDialog extends JDialog {
	...
	public StoreAlterDialog(JFrame frame, final JTable table, String id) {

		super(frame, false);
		service = new StoreService();
		Store = service.getStoreById(id);
		...
		textField.setText(Store.getKhm());
		textField.setColumns(10);

		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setText(Store.getCount() + "");
		...
		textField_5.setText(Store.getProductName());
		textField_5.setBounds(371, 111, 131, 21);
		getContentPane().add(textField_5);

		textField_7 = new JTextField();
		textField_7.setColumns(10);
		textField_7.setText(Store.getPrice() + "");
		...
		JLabel label_10 = new JLabel("修改商品信息");
